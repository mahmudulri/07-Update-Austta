        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Padding(
                  padding: EdgeInsets.only(left: scrrenHeight * 0.020),
                ...
                Padding(
                  ...
                  child: Text(
                    'My Profile',
                    style: GoogleFonts.poppins(
                        color: Colors.grey, fontSize: scrrenHeight * 0.015),
                  ),
                ),
                Spacer(),
                // Icon(
            ...
            Row(
              children: [
                Padding(
                  padding: EdgeInsets.only(left: scrrenHeight * 0.020),
                  child: Icon(Icons.wallet_giftcard,color: Colors.grey,),
                ),
                Padding(
                  padding: EdgeInsets.only(left: scrrenHeight * 0.012),
                  child: Text(
