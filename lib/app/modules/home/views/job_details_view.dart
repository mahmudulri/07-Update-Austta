...
class HomeJobDetailsView extends GetView {
  ...
  Widget build(BuildContext context) {
    ...
    print('indecccccccccccccx'+index.toString());
    return Scaffold(
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        controller.jobPost.value.latestJobs![int.parse(index.toString())].jobType.toString(),
                        style: GoogleFonts.poppins(
                          textStyle: TextStyle(
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        controller.jobPost.value.latestJobs![int.parse(index.toString())].departmentId.toString(),
                        style: GoogleFonts.poppins(
                          textStyle: TextStyle(
                            fontSize: screenHeigth * 0.018,
                            color: Color(0xff4F4F4F),
