...
class JobList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Center(
      ...
      itemCount: viewType != 'home' ? controller.jobPost.value.posts!.length : controller.jobPost.value.posts!.length >= 3  ?
       3 : controller.jobPost.value.posts!.length >=2 ? 2 : 1,
      itemBuilder: (_, index) {
        return Container(
                ...
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        controller.jobPost.value.posts![index].jobTitle.toString(),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            controller.jobPost.value.posts![index].applicationDeadline.toString(),
                            style: TextStyle(
