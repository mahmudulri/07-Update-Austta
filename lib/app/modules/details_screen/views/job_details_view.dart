          ...
          Container(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        controller.jobPost.value.posts![int.parse(index.toString())].jobTitle.toString().toUpperCase(),
                        style: GoogleFonts.poppins(
                      ...
                      Text(
                        controller.jobPost.value.posts![int.parse(index.toString())].createdAt.toString().substring(0,10),
                        style: GoogleFonts.poppins(
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        controller.jobPost.value.posts![int.parse(index.toString())].jobType.toString(),
                        style: GoogleFonts.poppins(
                          textStyle: TextStyle(
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        controller.jobPost.value.posts![int.parse(index.toString())].departmentId.toString(),
                        style: GoogleFonts.poppins(
                          textStyle: TextStyle(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        controller.jobPost.value.posts![int.parse(index.toString())].companyName.toString(),
                        style: GoogleFonts.poppins(
                          fontSize: screenHeigth * 0.018,
                          color: Color(0xff4F4F4F),
                        ),
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Html(data: controller.jobPost.value.posts![int.parse(index.toString())].jobDescription.toString(),
                  ),
                ],
              ),
              SizedBox(
              ...
              Row(
                children: [
                  ...
                  Text(
                    controller.jobPost.value.posts![int.parse(index.toString())].applicationDeadline.toString(),
                    style: GoogleFonts.poppins(
                      fontSize: screenHeigth * 0.018,
                      color: Color(0xff4F4F4F),
                    ),
