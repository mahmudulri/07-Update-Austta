...
class _PageOneState extends State<PageOne> {
  ...
  page_one_textfield(double screenHeigth, double screenWidth, Widget icon,
                  ...
                  hinttxt == "Full Name"
                      ...
                      : hinttxt == "Nick Name"
                          ...
                          : hinttxt == "Batch"
                              ...
                              : hinttxt == "Mobile No."
                                  ? regController.mobileNo.value =
                                      value.toString()
                                  : hinttxt == "Blood Group"
                                      ? regController.bloodGroup.value =
                                          value.toString()
                                      : regController.stream.value =
                                          value.toString();
                },
              ),
            ),
